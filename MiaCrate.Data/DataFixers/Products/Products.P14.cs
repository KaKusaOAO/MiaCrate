...
{
    public interface IP14 {}
    public interface IP14<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9,
        TField10, TField11, TField12, TField13, TField14> : IP14, 
        ...
        IPField13<TLeft, TField13>, IPField14<TLeft, TField14>
        where TLeft : IK1
    {
    }

    internal class 
        P14<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10, 
            TField11, TField12, TField13, TField14> : 
        IP14<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10, 
            TField11, TField12, TField13, TField14> 
        where TLeft : IK1
    {
        public P14(IApp<TLeft, TField1> t1, IApp<TLeft, TField2> t2, IApp<TLeft, TField3> t3, IApp<TLeft, TField4> t4,
            ...
            IApp<TLeft, TField13> t13, IApp<TLeft, TField14> t14)
        {
            T1 = t1;
            T2 = t2;
            T3 = t3;
