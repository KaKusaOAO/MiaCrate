...
{
    public interface IP15 {}
    public interface IP15<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9,
        TField10, TField11, TField12, TField13, TField14, TField15> : IP15, 
        ...
        IPField13<TLeft, TField13>, IPField14<TLeft, TField14>, IPField15<TLeft, TField15>
        where TLeft : IK1
    {
    }

    internal class 
        P15<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10, 
            TField11, TField12, TField13, TField14, TField15> : 
        IP15<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10, 
            TField11, TField12, TField13, TField14, TField15> 
        where TLeft : IK1
    {
        public P15(IApp<TLeft, TField1> t1, IApp<TLeft, TField2> t2, IApp<TLeft, TField3> t3, IApp<TLeft, TField4> t4,
            ...
            IApp<TLeft, TField13> t13, IApp<TLeft, TField14> t14, IApp<TLeft, TField15> t15)
        {
            T1 = t1;
            T2 = t2;
            T3 = t3;
