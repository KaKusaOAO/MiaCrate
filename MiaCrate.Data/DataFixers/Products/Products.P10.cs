...
{
    public interface IP10 {}
    public interface IP10<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9,
        TField10> : IP10, 
        ...
        IPField9<TLeft, TField9>, IPField10<TLeft, TField10>
        where TLeft : IK1
    {
    }

    internal class 
        P10<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10> : 
        IP10<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10> 
        where TLeft : IK1
    {
        public P10(IApp<TLeft, TField1> t1, IApp<TLeft, TField2> t2, IApp<TLeft, TField3> t3, IApp<TLeft, TField4> t4,
            IApp<TLeft, TField5> t5, IApp<TLeft, TField6> t6, IApp<TLeft, TField7> t7, IApp<TLeft, TField8> t8, 
            IApp<TLeft, TField9> t9, IApp<TLeft, TField10> t10)
        {
            T1 = t1;
            T2 = t2;
            T3 = t3;
