...
{
    public interface IP13 {}
    public interface IP13<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9,
        TField10, TField11, TField12, TField13> : IP13, 
        ...
        IPField13<TLeft, TField13> 
        where TLeft : IK1
    {
    }

    internal class 
        P13<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10, 
            TField11, TField12, TField13> : 
        IP13<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10, 
            TField11, TField12, TField13> 
        where TLeft : IK1
    {
        public P13(IApp<TLeft, TField1> t1, IApp<TLeft, TField2> t2, IApp<TLeft, TField3> t3, IApp<TLeft, TField4> t4,
