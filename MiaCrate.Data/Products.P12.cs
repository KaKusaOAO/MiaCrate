...
{
    public interface IP12 {}
    public interface IP12<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9,
        TField10, TField11, TField12> : IP12, 
    ...
    internal class 
        P12<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10, 
            TField11, TField12> : 
        IP12<TLeft, TField1, TField2, TField3, TField4, TField5, TField6, TField7, TField8, TField9, TField10, 
            TField11, TField12> 
        where TLeft : IK1
    {
        public P12(IApp<TLeft, TField1> t1, IApp<TLeft, TField2> t2, IApp<TLeft, TField3> t3, IApp<TLeft, TField4> t4,
