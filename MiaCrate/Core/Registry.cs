...
public static class Registry
{
    ...
    public static readonly IResourceKey<IRegistry<World.Entities.AI.Attribute>> AttributeRegistry =
    ...
    public static readonly IRegistry<World.Entities.AI.Attribute> Attribute = 
        RegisterSimple<World.Entities.AI.Attribute>(AttributeRegistry, r => Attributes.Luck);
