...
public readonly struct Uuid : IEquatable<Uuid>
{
    ...
    /// </summary>
    public long LeastSignificantBits => _leastSignificantBits;

    /// <summary>
    /// The most significant 64 bits of this UUID's 128 bit value.
    /// </summary>
    public long MostSignificantBits => _mostSignificantBits;
    ...
    public bool Equals(Uuid uuid) => _mostSignificantBits == uuid._mostSignificantBits &&
                                     _leastSignificantBits == uuid._leastSignificantBits;
    ...
    {
        var uuidMostSignificantBytes = BitConverter.GetBytes(_mostSignificantBits);
        var uuidLeastSignificantBytes = BitConverter.GetBytes(_leastSignificantBits);
        byte[] bytes =
        {
    ...
    public static explicit operator Guid(Uuid uuid)
    {
        ...
        var uuidMostSignificantBytes = BitConverter.GetBytes(uuid._mostSignificantBits);
        var uuidLeastSignificantBytes = BitConverter.GetBytes(uuid._leastSignificantBits);
        byte[] guidBytes =
        {
            uuidMostSignificantBytes[4],
            uuidMostSignificantBytes[5],
