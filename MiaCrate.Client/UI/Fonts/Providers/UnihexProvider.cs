...
public class UnihexProvider : IGlyphProvider
{
    ...
    private record Glyph(ILineData Contents, int Left, int Right) : IGlyphInfo
    {
        ...
        private class Info : ISheetGlyphInfo
        {
            ...
            public unsafe void Upload(AbstractTexture texture, int x, int y)
            {
                ...
                GlStateManager.Upload(texture, 0, x, y, _instance.Width, GlyphHeight, ptr, size, Marshal.FreeHGlobal);
            }
        }
    }
